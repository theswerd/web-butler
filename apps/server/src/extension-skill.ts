...
4. No network requests, no storage (localStorage/cookies/IndexedDB), no globals, no timers that outlive a navigation, no listening on events you don't need. The script's only job is the page change.
